        ...
        with open("productos.txt", "r") as archivo:
            for linea in archivo:
                ...
                if len(datos) == 3:  # Asegurarse de que haya 3 elementos
                    try:
                        # Eliminar etiquetas y extraer valores
                        nombre = datos[0].split(":")[1].strip()
                        precio = int(datos[1].split(":")[1].strip())
                        cantidad = int(datos[2].split(":")[1].strip())
                        ...
                        print("Error en el formato de una línea de 'productos.txt'.")
